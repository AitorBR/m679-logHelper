...
<a href="javascript:back()" class="btn float-right btn btn-success">Back ⬅️</a>

<script type="text/javascript" src="<?php echo e(asset('js/server_edit.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('js/validate.js')); ?>"></script>
</html>
<?php /**PATH D:\2n DAW\m6-m7-m9\proyectoLogHelperBien\loghelper_pract\logHelper\resources\views//server/server_edit.blade.php ENDPATH**/ ?>